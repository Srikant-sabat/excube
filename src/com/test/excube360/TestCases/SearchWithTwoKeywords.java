 ...
 *
 */
public class SearchWithTwoKeywords extends ReportGenerate {
    ...
    public void beforeclass()
     {
		test=extent.createTest("SearchWithTwoKeywords Verification");
	...
	public void Five_Words_Search() throws EncryptedDocumentException, InvalidFormatException, IOException{
		...
		lp.getSearch().click();
		lp.getSearch().sendKeys(gf.getExcldata("TwoKeyword", "Registersheet", "two key"));
		test.log(Status.INFO, "send TwoKeyword word");
