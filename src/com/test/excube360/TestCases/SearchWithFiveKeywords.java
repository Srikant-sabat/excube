 ...
 *
 */
public class SearchWithFiveKeywords extends ReportGenerate {
    ...
    public void beforeclass()
     {
		test=extent.createTest("SearchWithFiveKeywords Verification");
	...
	public void Five_Words_Search() throws EncryptedDocumentException, InvalidFormatException, IOException{
		try {
			...
			lp.getSearch().click();
			lp.getSearch().sendKeys(gf.getExcldata("FiveKeyword", "Registersheet", "five key"));
			test.log(Status.INFO, "send five word");
