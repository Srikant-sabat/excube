 ...
 *
 */
public class SearchWithFourKeywords extends ReportGenerate{
    ...
    public void beforeclass()
     {
		test=extent.createTest("SearchWithFourKeywords Verification");
	...
	public void Five_Words_Search() throws EncryptedDocumentException, InvalidFormatException, IOException{
		try {
			...
			test.log(Status.INFO, "send FourKeyword word");
